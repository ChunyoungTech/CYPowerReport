<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Edit.Master" AutoEventWireup="true" CodeBehind="CompanyDataEdit.aspx.cs" Inherits="WebApp._edit.CompanyDataEdit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="TabTitle" runat="server">
    <li class='tab'><a href="#tabs-1">公司基本資料</a></li>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="TabContent" runat="server">
    <div id="tabs-1" style="padding-top: 3px;">
        <table style="width: 100%;">
            <tr>
                <th class="label must">公司名稱</th>
                <td colspan="3">
                    <asp:TextBox ID="txtCOD_NAME" runat="server" Width="95%" MaxLength="150"></asp:TextBox>
                    <br /><asp:RequiredFieldValidator ID="COD_NAMEValidator" runat="server" ControlToValidate="txtCOD_NAME" CssClass="validmsg"
                        ErrorMessage="[公司名稱]必填" Display="Dynamic" ValidationGroup="btnConfirm"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <th class="label write">地址</th>
                <td colspan="3">
                    <asp:TextBox ID="txtCOD_ADDRESS" runat="server" Width="95%" MaxLength="200"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCOD_Tel" runat="server" Width="90%" MaxLength="50"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="label write">EMAIL</th>
                <td>
                    <asp:TextBox ID="txtCOD_EMail" runat="server" Width="90%" MaxLength="100"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th class="label write">聯絡</th>
                <td>
                    <asp:TextBox ID="txtCOD_Contact" runat="server" Width="90%" MaxLength="100"></asp:TextBox>
                </td>
            </tr>
