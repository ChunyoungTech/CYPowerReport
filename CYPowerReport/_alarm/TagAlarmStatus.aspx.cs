...
{
    public partial class TagAlarmStatus : BasePageGridMulti
    {
            ...
            if (chkType.SelectedValue.Length > 0)
            {
                ...
                foreach (ListItem item in chkType.Items.Cast<ListItem>())
                {
                    if (item.Selected)
                    {
                        ...
                        {
                            case "1":
                                str.Append("(B.ALL_Enable=0) or ");
                                break;
                            case "2":
                                str.Append("(B.HIHI_Enable=0) or ");
                                break;
                            case "3":
                                str.Append("(B.HI_Enable=0) or ");
                                break;
                            case "4":
                                str.Append("(B.LO_Enable=0) or ");
                                break;
                            case "5":
                                str.Append("(B.LOLO_Enable=0) or ");
                                break;
                            case "6":
